...
public class AirplaneBookingSystemDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var firstClient = new Client { Id = 1, PassportNumber = "738096", BirthdayDate = new DateTime(1969, 8, 15), Name = "Samoylov A. K." };
        var firstTicket = new Ticket { Id = 1, TicketNumber = 100, ClientId = 1, FlightId = 1 };

        var secondClient = new Client { Id = 2, PassportNumber = "258204", BirthdayDate = new DateTime(2002, 6, 4), Name = "Shestakov N. D." };
        ...
        var thirdClient = new Client { Id = 3, PassportNumber = "211702", BirthdayDate = new DateTime(1984, 10, 28), Name = "Fomina M. D." };
        var fourthTicket = new Ticket { Id = 4, TicketNumber = 01, ClientId = 3, FlightId = 2 };

        var fourthClient = new Client { Id = 4, PassportNumber = "783469", BirthdayDate = new DateTime(1978, 10, 17), Name = "Novikov Y. M." };
        var fifthTicket = new Ticket { Id = 5, TicketNumber = 202, ClientId = 4, FlightId = 2 };

        var fifthClient = new Client { Id = 5, PassportNumber = "481761", BirthdayDate = new DateTime(2013, 12, 7), Name = "Myasnikov S. I." };
        ...
        var sixthClient = new Client { Id = 6, PassportNumber = "154590", BirthdayDate = new DateTime(1993, 3, 21), Name = "Kapustina D. F." };
        var eighthTicket = new Ticket { Id = 8, TicketNumber = 400, ClientId = 6, FlightId = 4 };

        var seventhClient = new Client { Id = 7, PassportNumber = "303386", BirthdayDate = new DateTime(2013, 4, 3), Name = "Panfilova K. T." };
        var ninthTicket = new Ticket { Id = 9, TicketNumber = 401, ClientId = 7, FlightId = 4 };

        var eighthClient = new Client { Id = 8, PassportNumber = "240348", BirthdayDate = new DateTime(1966, 8, 17), Name = "Birukov D. M." };
        ...
        modelBuilder.Entity<User>().HasData(new List<User> { simpleUser, admin });
    }
}